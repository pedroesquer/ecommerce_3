    ...
    <body>
        ...
        <main>
            ...
            <div class = imagenes>
                ...
                <button class = "encima"><img src="./imgs/upload.png" alt=""  height="50" width="50"></button>
            </div>
         ...
         <div class = "zonaCancelarEditarUsuario">    
            <hr>
            <button type="button" class = "btn-cancelar" onclick="window.location.href = 'usuario.jsp' ">Volver</button>
        </div>
        <footer class = "footer">
