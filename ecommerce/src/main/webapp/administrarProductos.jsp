            ...
            <div class="contenido-general">
                <div class="botonRegresarAgregarProducto">
                    ...
                    <button class="btnAgregarProducto"
                        onclick="window.location.href='agregarProducto.html'">Agregar Producto</button>
                </div>

                <h1 class="misProductos">Mis Productos</h1>
            <div class="contenedorProductosMovil">
                <div class=panelProducto id="bujia1" onclick="window.location.href='editarProducto.html'">
