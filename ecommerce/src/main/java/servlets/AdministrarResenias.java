    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (listaProductos == null) {
                ...
                System.out.println("EXITO: Se encontraron " + listaProductos.size() + " productos.");
                if (!listaProductos.isEmpty()) {
                    System.out.println("Producto 1: " + listaProductos.get(0).getNombre());
                }
            }
            System.out.println("--------------------------------------------------");
            // ----------------------------------------
            
            // 2. Establecer la lista como atributo de solicitud
            request.setAttribute("listaProductos", listaProductos);
            
            // 3. Redirigir a la página JSP
            request.getRequestDispatcher("/administrarResenias.jsp").forward(request, response);
